export function JsonLd({ locale }: { locale: string }) {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      {
        "@type": "Question",
        name: "Has Eduardo worked with notable clients?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes — Eduardo has contributed to web work for UN agencies (UNAIDS, UNFPA, IOM, IFAD), EBU Eurovision News, AdTech platforms (UTIQ), NGOs (Covenant House), and startups. Detailed case studies are available on the Work page.",
        },
      },
    ],
  };
